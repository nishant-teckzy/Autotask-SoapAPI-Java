...
public class DeleteResponse  implements java.io.Serializable {
    private net.autotask.ATWS.v1_6.ATWSResponse deleteResult;

    public DeleteResponse() {
    }

    public DeleteResponse(
           net.autotask.ATWS.v1_6.ATWSResponse deleteResult) {
     ...
     * @return deleteResult
     */
    public net.autotask.ATWS.v1_6.ATWSResponse getDeleteResult() {
        return deleteResult;
    }
     ...
     * @param deleteResult
     */
    public void setDeleteResult(net.autotask.ATWS.v1_6.ATWSResponse deleteResult) {
        this.deleteResult = deleteResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://autotask.net/ATWS/v1_6/", ">deleteResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("deleteResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://autotask.net/ATWS/v1_6/", "deleteResult"));
