...
public class Update  implements java.io.Serializable {
    ...
    /**
     * Gets the entities value for this Update.
     * 
     * @return entities
     */
    ...
    /**
     * Sets the entities value for this Update.
     * 
     * @param entities
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://autotask.net/ATWS/v1_6/", ">update"));
